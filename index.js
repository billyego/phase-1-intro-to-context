function createEmployeeRecord(row){
  ...
  function hoursWorkedOnDate (employee, soughtDate){
      let inEvent = employee.timeInEvents.find(function(evo){
          return evo.date === soughtDate
      })
  
      let outEvent = employee.timeOutEvents.find(function(evo){
          return evo.date === soughtDate
      })
  ...
  function wagesEarnedOnDate(employee, dateSought){
      let grossWage = hoursWorkedOnDate(employee, dateSought)* employee.payPerHour
